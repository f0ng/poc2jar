...
//    private String tranDataToIndex;
    ...
    @FXML
    private TextArea mTextArea35; // 匹配的关键字

    @FXML
    private TextArea mTextArea36; // 匹配的关键字
...
//        System.out.println(exelist);
    ...
    public void onButton9Click(ActionEvent actionEvent) {
        ...
        if (python2or3.contains("python2")) {
            pythonpath = mTextField8.getText().trim(); // python2路径
        }else{
            pythonpath = mTextField82.getText().trim(); // python3路径
        }
